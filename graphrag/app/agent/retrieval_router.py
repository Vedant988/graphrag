...
class TigerGraphSupportAIRouter:
    ...
    _GRAPH_PATTERNS = (
        ...
        (re.compile(r"\brelat(?:ion|ed|ionship)\b"), "explicit_relationship_request"),
        (re.compile(r"\bfamili(?:al|y)\b"), "familial_relationship_request"),
        (re.compile(r"\bhow (?:are|were|is|was) .{0,40} (?:related|connected|linked)\b"), "explicit_relationship_request"),
